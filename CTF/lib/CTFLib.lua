...
CTF_LIB = {
	waitpos = {x = 395, y = 494, z =7}, -- Posição da sala de espera
	tppos = {x = 145, y = 41, z =7}, -- Onde o TP vai aparecer

	days = {4, 6, 7}, -- Dias que o evento vai abrir
	xp_percent = 20, -- Porcentagem de exp que o player vai ganhar
	...
	teams = {
		["Vermelho"] = {
			...
			flag = {
				id = 1435,
				flag_pos = {x = 368, y = 466, z =7}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 391, y = 481, z =7}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},
		...
		["Verde"] = {
			...
			flag = {
				id = 1437,
				flag_pos = {x = 420, y = 467, z =7}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 396, y = 460, z =7}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
